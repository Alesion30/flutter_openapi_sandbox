...
class _$Unauthorized extends Unauthorized {
  ...
  factory _$Unauthorized([void Function(UnauthorizedBuilder)? updates]) =>
      (new UnauthorizedBuilder()..update(updates))._build();

  _$Unauthorized._({required this.error}) : super._() {
    BuiltValueNullFieldError.checkNotNull(error, r'Unauthorized', 'error');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Unauthorized')..add('error', error))
        .toString();
  }
}
...
class UnauthorizedBuilder
  ...
  @override
  Unauthorized build() => _build();

  _$Unauthorized _build() {
    final _$result = _$v ??
        new _$Unauthorized._(
            error: BuiltValueNullFieldError.checkNotNull(
                error, r'Unauthorized', 'error'));
    replace(_$result);
    return _$result;
  }
}
