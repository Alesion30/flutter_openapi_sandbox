...
class _$Forbidden extends Forbidden {
  ...
  _$Forbidden._({required this.message}) : super._() {
    BuiltValueNullFieldError.checkNotNull(message, r'Forbidden', 'message');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Forbidden')..add('message', message))
        .toString();
  }
}
